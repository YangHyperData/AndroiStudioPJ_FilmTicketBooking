...
import com.example.ngothanhtriproject.Adapter.FimListAdapter
import com.example.ngothanhtriproject.Adapter.SliderAdapter
import com.example.ngothanhtriproject.Model.Film
import com.example.ngothanhtriproject.Model.SliderItems
import com.example.ngothanhtriproject.R
import com.example.ngothanhtriproject.databinding.ActivityMainBinding
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    if (items.isNotEmpty()) {
                        ...
                        binding.recyclerViewTopMovies.adapter = FimListAdapter(items)
                    }
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                if (snapshot.exists()) {
                    ...
                    if (items.isNotEmpty()) {
                        ...
                        binding.recyclerViewUpcoming.adapter = FimListAdapter(items)
                    }
